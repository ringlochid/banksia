...
from banksia.runtime.file_references import validate_file_references, validate_workspace
from banksia.runtime.ids import flow_id_for_task
from banksia.runtime.launch.continuation import stage_initial_root_dispatch
...
async def _admit_task_in_workspace_lane(
    ...
    *,
    ...
    await recover_task_workspace_admissions(session, workspaces=(workspace,))
    ...
    try:
        await launch_task_runtime(
            ...
            RuntimeLaunchInput(
                ...
                workflow_revision=workflow_revision,
                assignment=assignment,
                compiler_version="workflow-team-migration",
        ...
        return await stage_initial_root_dispatch(
            session,
            flow_id=flow_id_for_task(task_id),
            dependencies=dependencies,
        )
