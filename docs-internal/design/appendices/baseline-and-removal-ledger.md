...
| Command Run environment/expected-output refs and split output | Controller-approved environment, simple request, one complete workspace log with bounded reads and no duplicate full body | WP-04 owns output; WP-05 owns operation/Continuation shape. |
