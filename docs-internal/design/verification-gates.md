...
- Operator draft changes use the shared controller Workflow service and show receipt/Undo; publish/start/controls/destructive unrequested actions require explicit authority/confirmation.
