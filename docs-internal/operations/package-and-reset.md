...
`pyproject.toml` is the package contract. The distribution, Python package, and console command are `banksia` at version `0.1.0`, and Python 3.12 or newer is required.
