...
- [Getting started](start/getting-started.md) — install Banksia, configure a provider, and complete a first developer or researcher run.
...
- [Report an issue](https://github.com/ringlochid/banksia/issues) — include the smallest redacted evidence that reproduces the problem.
