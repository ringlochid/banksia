...
At task start, Banksia validates task-compose against current definition-registry truth and pins the revisions used by the task. Later definition changes do not silently rewrite that running task.
