...
_OPERATOR_MCP_INSTRUCTIONS = (
    ...
    "- workflow_draft_create is the discriminated create-or-open entry; "
    "workflow_draft_edit, workflow_draft_validate, "
    ...
    "Draft creation, opening, editing, and validation never publish or start runtime work.\n\n"
    "Runs:\n"
