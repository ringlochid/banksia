...
from oh_my_subagents.persistence.models.runtime.common import sql_in, utcnow

if TYPE_CHECKING:
    from oh_my_subagents.persistence.models.runtime.assignment.execution import AssignmentModel
    ...
    from oh_my_subagents.persistence.models.runtime.team import TeamRevisionMemberModel
