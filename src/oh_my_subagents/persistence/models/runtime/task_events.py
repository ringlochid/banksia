...
if TYPE_CHECKING:
    from oh_my_subagents.persistence.models.runtime.assignment.execution import AttemptModel
...
class TaskEventModel(RuntimeBase):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ...
            name="fk_task_events_team_revision",
            deferrable=True,
            initially="DEFERRED",
        ),
    ...
    team_revision_id: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    ...
    team_revision: Mapped[TeamRevisionModel | None] = relationship(
        "TeamRevisionModel",
