...
from oh_my_subagents.persistence.models.runtime.common import utcnow
...
if TYPE_CHECKING:
    ...
    from oh_my_subagents.persistence.models.runtime.delegation import DelegationWaveModel
    from oh_my_subagents.persistence.models.runtime.dispatch.turns import DispatchTurnModel
    from oh_my_subagents.persistence.models.runtime.human_requests import HumanRequestModel
...
class AttemptWaitModel(RuntimeBase):
    ...
    attempt: Mapped[AttemptModel] = relationship(
        ...
        foreign_keys=[task_id, assignment_id, attempt_id, wait_id],
        lazy="raise",
        viewonly=True,
    )
