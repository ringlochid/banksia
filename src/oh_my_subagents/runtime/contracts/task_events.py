...
from oh_my_subagents.runtime.contracts.task_event_payloads import (
...
class _TaskEventEnvelope(BaseModel):
    ...
    team_revision_id: TaskEventIdentifier | None = None
    dispatch_id: TaskEventIdentifier | None = None
    attempt_id: TaskEventIdentifier | None = None
    member_id: TaskEventIdentifier | None = None
...
class TaskEventRecord(RootModel[_TaskEventVariant]):
    ...
    @property
    def team_revision_id(self) -> str | None:
        return self.root.team_revision_id
