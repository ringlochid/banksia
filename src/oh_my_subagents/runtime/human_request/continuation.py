...
from oh_my_subagents.persistence.models import AttemptModel, HumanRequestModel, TaskModel
...
from oh_my_subagents.runtime.post_commit import HumanRequestTerminal
