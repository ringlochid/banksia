...
from oh_my_subagents.persistence.models import TaskEventModel, TaskEventStreamHeadModel
from oh_my_subagents.runtime.clock import utc_now
from oh_my_subagents.runtime.contracts.primitives import TaskEventSource, TaskEventType
from oh_my_subagents.runtime.contracts.task_events import (
    TaskEventListQuery,
    TaskEventListResponse,
    TaskEventRecord,
)
from oh_my_subagents.runtime.ids import task_event_id
...
async def append_task_event(
    ...
    *,
    ...
    team_revision_id: str | None = None,
    ...
    row = TaskEventModel(
        ...
        team_revision_id=record.team_revision_id,
