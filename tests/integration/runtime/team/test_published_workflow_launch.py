...
async def test_runtime_launch_consumes_one_real_published_workflow_revision(
            ...
            staged = await launch_task_runtime(
                ...
                RuntimeLaunchInput(
                    ...
                    assignment=AssignmentBody(
                        prompt="Launch exact production-feature-delivery truth.",
                    ),
                ),
            )
    ...
    assert task.workflow_key == "production-feature-delivery"
    ...
    assert assignment.member_id == "feature-lead"
    ...
    assert staged.bootstrap.assignment.prompt == "Launch exact production-feature-delivery truth."
